...
> **This is a fork.** It is [jjr-sys/reolink-native-linux](https://github.com/jjr-sys/reolink-native-linux), a fork of [TodesengelX/reolink-native-linux](https://github.com/TodesengelX/reolink-native-linux) (based on v0.1.8), versioned separately as `0.3.0-jjr`. On top of upstream it adds **live camera audio**, **two-way talk**, **playback audio** and **camera paging**. The app shows a FORK badge beside its version. Upstream owns the original design and most of the code; this fork is not affiliated with or endorsed by it or by Reolink.
