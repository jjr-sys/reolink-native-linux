...
> **This is a fork.** It is [jjr-sys/reolink-native-linux](https://github.com/jjr-sys/reolink-native-linux), a fork of [TodesengelX/reolink-native-linux](https://github.com/TodesengelX/reolink-native-linux) (based on v0.1.8), versioned separately as `0.4.0-jjr`. On top of upstream it adds **live camera audio**, **two-way talk**, **playback audio**, **camera paging** and a **downloads manager**. The app shows a FORK badge beside its version. Upstream owns the original design and most of the code; this fork is not affiliated with or endorsed by it or by Reolink.

> **Status: alpha.** Actively developed against a real RLN8-410 NVR, with community-confirmed setups on an RLC-823S1 standalone camera and a Home Hub Pro. Live view, playback, events, notifications and device settings all work; live camera audio and two-way talk work from the live grid; audio in recordings/playback, doorbell quick replies and remote/P2P access are still in progress.
